...
class HomeController extends Controller
{
    ...
    public function index()
    {
      ...
      $jobs = Ad::where('type','1')->where('created_at','>',Carbon::now()->subMonths(2))->orderBy('created_at','desc')->paginate(4);
      $offers = Ad::where('type','2')->where('created_at','>',Carbon::now()->subMonths(2))->orderBy('created_at','desc')->paginate(4);
