  ...
  <ol class="breadcrumb">
    ...
    Om een oproep te kunnen plaatsen dient u in de eerste plaats te <a href="{{route('register')}}">registreren</a>. Vervolgens kiest u in het menu voor ‘Plaats een vacature’ en vult u alle velden zo volledig mogelijk in. Als u hiermee klaar bent klikt u op ‘Opslaan’. De vacature is nu geplaatst en direct zichtbaar.
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapsetwelve">Hoe plaats ik een oproep?</a>
                </h4>
            </div>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapsethirteen">Mijn cerfiticaat, vaardigheid of diploma staat er niet bij, wat nu?</a>
                </h4>
            </div>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapsefourteen">Ik heb een andere vraag..</a>
                </h4>
            </div>
