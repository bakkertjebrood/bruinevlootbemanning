...
<div class="container">
  ...
  <div class="col-lg-3">
    ...
    <div class="list-group profile-menu">
      ...
      <h4>Ga naar</h4>
      <a href="{{route('ads')}}" class="list-group-item">
        <span class="glyphicon glyphicon-bullhorn"></span>
        Alle oproepen</a>
      <a href="{{route('ads')}}" class="list-group-item">
        <span class="glyphicon glyphicon-ok-circle"></span>
...
<h4>Nieuwe leden</h4>
  ...
  <div class="col-lg-9">
    ...
    <div class="header">
      <a class="pull-right hidden-xs" href="{{route('ads')}}"><small>Bekijk alle vacatures</small></a>
        ...
        <div class="thumbnail">
          ...
          <div class="caption clearfix">
            ...
            <span class="ad_block_footer">
              <a type="button" class="btn btn-sm btn-default" href="{{url('/ad',$ad->id)}}" name="button">Bekijken</a>
              @if(Auth::user())
    ...
    <div class="header">
      <a class="pull-right hidden-xs" href="{{route('ads')}}"><small>Bekijk alle oproepen</small></a>
    ...
    <div class="header">
      <a class="pull-right hidden-xs" href="{{route('ads')}}"><small>Bekijk alle goederen</small></a>
      <h2>Goederen <small>een greep</small></h2>
    </div>
